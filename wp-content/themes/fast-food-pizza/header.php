    ...
    <div id="header">
      ...
      if(has_nav_menu('responsive-menu')){ ?>
        <div class="toggle-menu responsive-menu">
          <button role="tab" onclick="fast_food_pizza_menu_open()" class="mobiletoggle"><i class="<?php echo esc_attr(get_theme_mod('fast_food_pizza_responsive_menu_open_icon','fas fa-bars')); ?>"></i><?php echo esc_html( get_theme_mod('fast_food_pizza_open_menu_label', __('Open Menu','fast-food-pizza'))); ?><span class="screen-reader-text"><?php esc_html_e('Open Menu','fast-food-pizza'); ?></span>
          </button>
        </div>
        <div id="navbar-header" class="menu-brand primary-nav resp-menu">
          ...
          <a href="javascript:void(0)" class="closebtn responsive-menu" onclick="fast_food_pizza_menu_close()"><?php echo esc_html( get_theme_mod('fast_food_pizza_close_menu_label', __('Close Menu','fast-food-pizza'))); ?><i class="<?php echo esc_attr(get_theme_mod('fast_food_pizza_responsive_menu_close_icon','fas fa-times')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Close Menu','fast-food-pizza'); ?></span></a>
        </div>
      <?php }?>
      <div class="<?php if( get_theme_mod( 'fast_food_pizza_sticky_header', false) != '') { ?> sticky-header<?php } else { ?>close-sticky <?php } ?>">
        <div class="topbar">
          <div class="container">
            <div class="row">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="offset-lg-2 col-lg-3 col-md-3 woo-icons align-self-center text-md-end my-md-0 my-3">
              <?php if( get_theme_mod( 'fast_food_pizza_display_search', true) == true ) { ?>
